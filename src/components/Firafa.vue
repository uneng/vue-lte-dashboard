  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a href="#" class="nav-link">simdBOS</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            <a href="#" class="dropdown-item">
              ...
              <div class="media">
                <img
                  src="lte/dist/img/user1-128x128.jpg"
                  alt="User Avatar"
            ...
            <a href="#" class="dropdown-item">
              ...
              <div class="media">
                <img
                  src="lte/dist/img/user8-128x128.jpg"
                  alt="User Avatar"
            ...
            <a href="#" class="dropdown-item">
              ...
              <div class="media">
                <img
                  src="lte/dist/img/user3-128x128.jpg"
                  alt="User Avatar"
                  class="img-size-50 img-circle mr-3"
                />
                <div class="media-body">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="#" class="brand-link">
        <img
          ...
          style="opacity: 0.8"
        />
        <span class="brand-text font-weight-light">simdBOS</span>
      </a>
                    ...
                    <ul class="contacts-list">
                      ...
                      <li>
                        <a href="#">
                          <img
                            class="contacts-list-img"
                            src="lte/dist/img/user7-128x128.jpg"
                          />
                      ...
                      <li>
                        <a href="#">
                          <img
                            class="contacts-list-img"
                            src="lte/dist/img/user5-128x128.jpg"
                          />
                      ...
                      <li>
                        <a href="#">
                          <img
                            class="contacts-list-img"
                            src="lte/dist/img/user6-128x128.jpg"
                          />
    ...
    <footer class="main-footer text-sm">
      <div class="float-right d-none d-sm-block"><b>V</b> 3.0</div>
      <strong
        >Copyright &copy; 2020-2021
        <a href="https://firafa.com">firafa.com</a>.</strong
      >
      All rights reserved.
    </footer>
  </div>
